from layers.DA_LSTM_layers import *
import torch
...
class DA_LSTM(nn.Module):
    def __init__(self, args, encoder, decoder, feature_attention_size):
        super(DA_LSTM, self).__init__()
        self.args = args
        self.encoder = encoder
        self.decoder = decoder
        self.feature_attention = SelfConcatAttentionForSeq(input_size=self.args.input_feature, attention_size=4)

    def forward(self, encoder_x, **kwargs):
